...
insert into Role (id, roles) values (1, 'ROLE_USER');
insert into Role (id, roles) values (2, 'ROLE_ADMIN');
insert into Role (id, roles) values (3, 'ROLE_USER, ROLE_ADMIN');
insert into Role (id, roles) values (1, 'ROLE_USER');
insert into Role (id, roles) values (2, 'ROLE_ADMIN');
insert into Role (id, roles) values (3, 'ROLE_ADMIN, ROLE_USER');
